document.addEventListener('DOMContentLoaded', function() {
    ...
    const galleryImages = document.querySelectorAll('.gallery-item img'); // Cambié esto para seleccionar las imágenes
    ...
    if (galleryWrapper && galleryImages.length) {
        ...
        function centerImage(index) {
            const itemWidth = galleryImages[index].offsetWidth;
            const offset = -index * itemWidth + (galleryWrapper.offsetWidth / 2 - itemWidth / 2);
        ...
        galleryImages.forEach((image, index) => {
            image.addEventListener('click', () => {
                ...
                img.src = image.src; // Cambiar la fuente de la imagen ampliada
                captionText.innerHTML = image.alt; // Mostrar el texto alternativo
            });
        });
    }
    ...
    modalImg.src = img.src; // Copia la fuente de la imagen a mostrar
    captionText.innerHTML = img.alt; // Muestra el texto alternativo como título
}
